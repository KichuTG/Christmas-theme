...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '''<b>☃️ ꜰɪʟᴇ ɴᴀᴍᴇ :</b> `{file_name}` \n\n <b>❄️ ꜰɪʟᴇ ꜱɪᴢᴇ :</b> `{file_size}` \n\n <b>🎄 ᴘᴏᴡᴇʀᴇᴅ ʙʏ : </b><a href='https://t.me/dramaship'><b>@ᴅʀᴀᴍᴀꜱʜɪᴘ</b></a> \n\n<b>ᴡɪꜱʜɪɴɢ ʏᴏᴜ ᴀ ᴍᴇʀʀʏ ᴄʜʀɪꜱᴛᴍᴀꜱ ꜰɪʟʟᴇᴅ ᴡɪᴛʜ ʟᴏᴠᴇ, ʟᴀᴜɢʜᴛᴇʀ, ᴀɴᴅ ᴇɴᴅʟᴇꜱꜱ ᴊᴏʏ.🎅🎄❄️☃️</b>''')
