...
async def start(client, message):
    sticker_message = await message.reply_sticker("CAACAgQAAxkBAAENXzJnZ5_pSJe-hfuSYUQuQ7-2M-nMXgAC5BQAApZLaFCRBOz13yIu0DYE")  # Replace "sticker_id" with the actual ID of the sticker
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('☃︎ ᴏᴡɴᴇʀ ☃︎', callback_data="owner_info"),
    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('☃︎ BOT 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 ☃︎', url="https://t.me/AM_FILMS") ] ] ),
            )
        return
